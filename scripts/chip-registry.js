...
const CHIP_REGISTRY = [
  ...
  // ----- C · Identity / self-concept (3) -----
  { id: 'self-doubt',     file: '09-self-doubt.md',            label: 'Self-Doubt',                 cat: 'C' },
  { id: 'coaching-mech',  file: '18-coaching-as-mechanism.md', label: 'Coaching as mechanism',      cat: 'C' },
  { id: 'mastermind-mech', file: '19-mastermind-as-mechanism.md', label: 'Mastermind as mechanism', cat: 'C' },
